...
def test_company_contact_discovery_does_not_silently_ignore_relation_error():
    from eqazyna_bitrix.reassign_by_company_id_batch import Bitrix, BitrixError
    ...
    bx = Fake()
    try:
        bx.list_direct_company_contact_ids("100", max_pages=1)
